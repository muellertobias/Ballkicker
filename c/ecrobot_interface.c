 ...
 * Note that default sensor mode is LIGHTSENSOR_NONE
 * @param port_id: NXT_PORT_S1/NXT_PORT_S2/NXT_PORT_S3/NXT_PORT_S4
 */
void ecrobot_init_nxtcolorsensor(U8 port_id)
{
	if (deviceStatus == DEVICE_NO_INIT)
	{
		colorsensor_init(port_id, LIGHTSENSOR_NONE);
	}
}
 ...
 * @param port_id: NXT_PORT_S1/NXT_PORT_S2/NXT_PORT_S3/NXT_PORT_S4
 * @param mode: COLORSENSOR/LIGHTSENSOR_RED/LIGHTSENSOR_GREEN/LIGHTSENSOR_BLUE/LIGHTSENSOR_FULL/LIGHTSENSOR_NONE
 */
void ecrobot_set_nxtcolorsensor(U8 port_id, U8 mode)
{
	...
	colorsensor_init(port_id, mode);
}

/**
 * gets light sensor data
 * Note that this API is valid for only when LIGHTSENSOR_RED/GREEN/BLUE/FULL/NONE is configured as the sensor mode
 * @param port_id: NXT_PORT_S1/NXT_PORT_S2/NXT_PORT_S3/NXT_PORT_S4
 * @return 0-1023 raw light sensor data
 */
U16 ecrobot_get_nxtcolorsensor_light(U8 port_id)
{
	return (U16)colorsensor_light_get(port_id);
}
 ...
 * @param port_id: NXT_PORT_S1/NXT_PORT_S2/NXT_PORT_S3/NXT_PORT_S4
 * @return BLACK/DARK_BLUE/LIGHT_BLUE/GREEN/YELLOW/RED/WHITE
 */
U16 ecrobot_get_nxtcolorsensor_id(U8 port_id)
{
	return (U16)colorsensor_color_get(port_id);
}

/**
 * gets color sensor data by RGB
 * Note that this API is valid for only COLORSENSOR mode
 * @param port_id: NXT_PORT_S1/NXT_PORT_S2/NXT_PORT_S3/NXT_PORT_S4
...
{
	int buf[3];
	colorsensor_rgb_get(port_id, buf);
	rgb[0] = (S16)buf[0];
	rgb[1] = (S16)buf[1];
	rgb[2] = (S16)buf[2];
}
